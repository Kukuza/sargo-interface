...
const outlineButtonClassNames =
  ...
  return (
    <div className="p-1 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white font-bold py-2 px-4 border border-black hover:border-transparent rounded-full h-[56px] w-[286px] buttonText">
      <button
        p-1={
